...
<Callout>
This method requires you to switch to the terminal to create notes. I don't find it to be that big a deal, but if that sounds like a pain in the ass, this method probably won't work for you.
</Callout>
