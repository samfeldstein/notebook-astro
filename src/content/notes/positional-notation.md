...
The unit value is the [[notes/base-mathematics|base]] to the power of the digit's position:
...
Another way to put it is that the value of a digit ($d$) is a function of its individual value, position ($p$) in the number, and the [[notes/base-mathematics|base]] ($b$):
