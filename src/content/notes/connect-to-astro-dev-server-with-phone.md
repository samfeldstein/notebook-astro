...
This will work on a private network, but may not work on a public network. In that case, you can switch to a hotspot or use [[notes/vs-code-port-forwarding|VS Code port forwarding]].