...
To calculate the value of [[notes/positional-notation|positional numbers]], we calculate the actual values of its digits and add them together. To find the actual value of a digit, we multiply the digit ($d$) by the base ($b$) to the power of the digit's position ($p$):
...
- [[notes/positional-notation|Positional Notation]]