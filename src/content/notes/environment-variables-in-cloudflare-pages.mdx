...
<Callout>This is how I did it with Astro, which I think use native ES6 syntax for environment variable imports, which makes me think it should work the same elsewhere, but don't hold me to it.</Callout>
